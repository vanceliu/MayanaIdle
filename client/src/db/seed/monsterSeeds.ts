...
export const MONSTER_SEEDS: MonsterTemplate[] = [
  ...
  // 龍之谷外圍 Lv.30~35
  { id: 224, name: '谷口幼龍', level: 31, hp: 225, attackMin: 23, attackMax: 33, defense: 15, exp: 455, race: 'dragon', size: 'small', element: 'wind', area: 'dragon-valley-outskirts', isBoss: false },
  { id: 38, name: '高階骷髏神射手', level: 32, hp: 240, attackMin: 24, attackMax: 35, defense: 15, exp: 490, race: 'undead', size: 'small', element: 'none', attackType: 'ranged', attackRange: 10, area: 'dragon-valley-outskirts', isBoss: false },
  { id: 37, name: '高階骷髏警衛', level: 33, hp: 260, attackMin: 26, attackMax: 37, defense: 16, exp: 530, race: 'undead', size: 'small', element: 'none', area: 'dragon-valley-outskirts', isBoss: false, debuffs: [{ type: 'curse', chance: 12 }] },
  { id: 225, name: '高階骷髏斥候', level: 34, hp: 270, attackMin: 27, attackMax: 38, defense: 17, exp: 550, race: 'undead', size: 'small', element: 'none', area: 'dragon-valley-outskirts', isBoss: false, debuffs: [{ type: 'bleed', chance: 15 }] },
  { id: 226, name: '熔岩巨蜥', level: 35, hp: 300, attackMin: 28, attackMax: 40, defense: 18, exp: 600, race: 'normal', size: 'large', element: 'fire', area: 'dragon-valley-outskirts', isBoss: false },
  // 龍之谷（地表）Lv.36~40
  { id: 39, name: '高階骷髏鬥士', level: 36, hp: 320, attackMin: 30, attackMax: 42, defense: 19, exp: 640, race: 'undead', size: 'small', element: 'none', area: 'dragon-valley-surface', isBoss: false, debuffs: [{ type: 'curse', chance: 12 }] },
  ...
  { id: 222, name: '巨人', level: 38, hp: 360, attackMin: 33, attackMax: 46, defense: 21, exp: 730, race: 'normal', size: 'large', element: 'earth', area: 'dragon-valley-surface', isBoss: false, debuffs: [{ type: 'stun', chance: 10 }] },
  { id: 223, name: '高階骷髏將領', level: 39, hp: 375, attackMin: 34, attackMax: 47, defense: 22, exp: 750, race: 'undead', size: 'small', element: 'none', area: 'dragon-valley-surface', isBoss: false, debuffs: [{ type: 'weaken', chance: 15 }] },
  { id: 36, name: '飛龍', level: 40, hp: 390, attackMin: 35, attackMax: 48, defense: 22, exp: 780, race: 'dragon', size: 'large', element: 'wind', area: 'dragon-valley-surface', isBoss: false, debuffs: [{ type: 'bleed', chance: 18 }] },
  // 遠古戰場 Lv.40~45
  ...
  // 龍谷地間 1F Lv.40~43
  { id: 84, name: '高階骷髏警衛', level: 40, hp: 380, attackMin: 35, attackMax: 48, defense: 22, exp: 780, race: 'undead', size: 'small', element: 'none', area: 'dragon-valley-1f', isBoss: false, debuffs: [{ type: 'curse', chance: 12 }] },
  { id: 85, name: '高階骷髏神射手', level: 40, hp: 360, attackMin: 34, attackMax: 47, defense: 21, exp: 760, race: 'undead', size: 'small', element: 'none', attackType: 'ranged', attackRange: 10, area: 'dragon-valley-1f', isBoss: false },
  { id: 86, name: '高階骷髏鬥士', level: 42, hp: 410, attackMin: 37, attackMax: 51, defense: 23, exp: 840, race: 'undead', size: 'small', element: 'none', area: 'dragon-valley-1f', isBoss: false, debuffs: [{ type: 'curse', chance: 12 }] },
  ...
  // 龍谷地間 2F Lv.40~43
  { id: 88, name: '高階骷髏警衛', level: 41, hp: 390, attackMin: 36, attackMax: 49, defense: 22, exp: 800, race: 'undead', size: 'small', element: 'none', area: 'dragon-valley-2f', isBoss: false, debuffs: [{ type: 'curse', chance: 12 }] },
  { id: 89, name: '高階骷髏神射手', level: 41, hp: 370, attackMin: 35, attackMax: 48, defense: 21, exp: 780, race: 'undead', size: 'small', element: 'none', attackType: 'ranged', attackRange: 10, area: 'dragon-valley-2f', isBoss: false },
  { id: 90, name: '高階骷髏鬥士', level: 43, hp: 420, attackMin: 38, attackMax: 52, defense: 24, exp: 860, race: 'undead', size: 'small', element: 'none', area: 'dragon-valley-2f', isBoss: false, debuffs: [{ type: 'curse', chance: 12 }] },
  ...
  // 龍谷地間 3F Lv.43~46
  { id: 92, name: '高階骷髏警衛', level: 43, hp: 420, attackMin: 38, attackMax: 52, defense: 24, exp: 860, race: 'undead', size: 'small', element: 'none', area: 'dragon-valley-3f', isBoss: false, debuffs: [{ type: 'curse', chance: 12 }] },
  { id: 93, name: '高階骷髏神射手', level: 44, hp: 430, attackMin: 39, attackMax: 53, defense: 24, exp: 890, race: 'undead', size: 'small', element: 'none', attackType: 'ranged', attackRange: 10, area: 'dragon-valley-3f', isBoss: false },
  { id: 94, name: '高階骷髏鬥士', level: 45, hp: 460, attackMin: 40, attackMax: 55, defense: 26, exp: 940, race: 'undead', size: 'small', element: 'none', area: 'dragon-valley-3f', isBoss: false, debuffs: [{ type: 'curse', chance: 12 }] },
  ...
  // 龍谷地間 4F Lv.43~46
  { id: 96, name: '高階骷髏警衛', level: 44, hp: 430, attackMin: 39, attackMax: 53, defense: 24, exp: 880, race: 'undead', size: 'small', element: 'none', area: 'dragon-valley-4f', isBoss: false, debuffs: [{ type: 'curse', chance: 12 }] },
  { id: 97, name: '高階骷髏神射手', level: 45, hp: 440, attackMin: 40, attackMax: 54, defense: 25, exp: 910, race: 'undead', size: 'small', element: 'none', attackType: 'ranged', attackRange: 10, area: 'dragon-valley-4f', isBoss: false },
  { id: 98, name: '高階骷髏鬥士', level: 46, hp: 480, attackMin: 42, attackMax: 57, defense: 27, exp: 970, race: 'undead', size: 'small', element: 'none', area: 'dragon-valley-4f', isBoss: false, debuffs: [{ type: 'curse', chance: 12 }] },
  ...
  { id: 102, name: '高階骷髏鬥士', level: 48, hp: 510, attackMin: 44, attackMax: 60, defense: 28, exp: 1050, race: 'undead', size: 'small', element: 'none', area: 'dragon-valley-5f', isBoss: false, debuffs: [{ type: 'curse', chance: 12 }] },
  // 龍谷地間 6F Lv.46~49
  ...
  { id: 105, name: '高階骷髏鬥士', level: 49, hp: 530, attackMin: 45, attackMax: 62, defense: 29, exp: 1080, race: 'undead', size: 'small', element: 'none', area: 'dragon-valley-6f', isBoss: false, debuffs: [{ type: 'curse', chance: 12 }] },
