...
export const MONSTER_SEEDS: MonsterTemplate[] = [
  ...
  { id: 29, name: '高等妖魔鬥士', level: 35, hp: 300, attackMin: 28, attackMax: 42, defense: 18, exp: 600, race: 'demon', size: 'small', element: 'dark', area: 'demon-forest', isBoss: false, debuffs: [{ type: 'curse', chance: 12 }] },
  ...
  { id: 47, name: '高等妖魔鬥士', level: 43, hp: 430, attackMin: 38, attackMax: 52, defense: 24, exp: 880, race: 'demon', size: 'small', element: 'dark', area: 'misty-cave-1f', isBoss: false, debuffs: [{ type: 'curse', chance: 12 }] },
  // 朦朧洞窟 2F Lv.43~46
  ...
  { id: 87, name: '剝皮蜘蛛', level: 41, hp: 370, attackMin: 35, attackMax: 48, defense: 21, exp: 790, race: 'normal', size: 'small', element: 'dark', area: 'dragon-valley-1f', isBoss: false, debuffs: [{ type: 'poison', chance: 18 }] },
  // 龍谷地間 2F Lv.40~43
  ...
  { id: 91, name: '剝皮蜘蛛', level: 42, hp: 380, attackMin: 36, attackMax: 49, defense: 22, exp: 810, race: 'normal', size: 'small', element: 'dark', area: 'dragon-valley-2f', isBoss: false, debuffs: [{ type: 'poison', chance: 18 }] },
  // 龍谷地間 3F Lv.43~46
  ...
  { id: 95, name: '大莫蜘蛛', level: 44, hp: 470, attackMin: 40, attackMax: 54, defense: 25, exp: 910, race: 'normal', size: 'large', element: 'dark', area: 'dragon-valley-3f', isBoss: false, debuffs: [{ type: 'poison', chance: 20 }] },
  // 龍谷地間 4F Lv.43~46
  ...
  { id: 99, name: '大莫蜘蛛', level: 45, hp: 490, attackMin: 41, attackMax: 56, defense: 26, exp: 940, race: 'normal', size: 'large', element: 'dark', area: 'dragon-valley-4f', isBoss: false, debuffs: [{ type: 'poison', chance: 20 }] },
  // 龍谷地間 5F Lv.46~49
  { id: 100, name: '大莫蜘蛛', level: 47, hp: 520, attackMin: 44, attackMax: 60, defense: 28, exp: 1030, race: 'normal', size: 'large', element: 'dark', area: 'dragon-valley-5f', isBoss: false, debuffs: [{ type: 'poison', chance: 20 }] },
  ...
  // 龍谷地間 6F Lv.46~49
  { id: 103, name: '大莫蜘蛛', level: 48, hp: 540, attackMin: 45, attackMax: 61, defense: 29, exp: 1060, race: 'normal', size: 'large', element: 'dark', area: 'dragon-valley-6f', isBoss: false, debuffs: [{ type: 'poison', chance: 20 }] },
  ...
  { id: 106, name: '大莫蜘蛛', level: 49, hp: 550, attackMin: 46, attackMax: 63, defense: 30, exp: 1090, race: 'normal', size: 'large', element: 'dark', area: 'dragon-valley-7f', isBoss: false, debuffs: [{ type: 'poison', chance: 20 }] },
  ...
  { id: 109, name: '安塔巨龍', level: 50, hp: 2500, attackMin: 60, attackMax: 82, defense: 38, exp: 6000, race: 'dragon', size: 'large', element: 'dark', area: 'dragon-valley-7f', isBoss: true, debuffs: [{ type: 'bleed', chance: 15 }, { type: 'curse', chance: 15 }, { type: 'stun', chance: 15 }] },
  // 遠古地監 1F Lv.45~50
  ...
  // 遠古地監 7F Lv.55~60
  { id: 125, name: '遠古凶獸', level: 56, hp: 680, attackMin: 54, attackMax: 73, defense: 34, exp: 1340, race: 'normal', size: 'large', element: 'none', area: 'ancient-dungeon-7f', isBoss: false, debuffs: [{ type: 'bleed', chance: 20 }, { type: 'stun', chance: 10 }] },
  ...
  { id: 128, name: '遠古食人妖精', level: 57, hp: 620, attackMin: 52, attackMax: 70, defense: 33, exp: 1280, race: 'demon', size: 'small', element: 'dark', area: 'ancient-dungeon-7f', isBoss: false, debuffs: [{ type: 'curse', chance: 18 }] },
  // 遠古地監 8F Lv.55~60
  { id: 129, name: '遠古凶獸', level: 58, hp: 710, attackMin: 56, attackMax: 76, defense: 36, exp: 1400, race: 'normal', size: 'large', element: 'none', area: 'ancient-dungeon-8f', isBoss: false, debuffs: [{ type: 'bleed', chance: 20 }, { type: 'stun', chance: 10 }] },
  ...
  { id: 132, name: '遠古食人妖精', level: 59, hp: 650, attackMin: 54, attackMax: 73, defense: 34, exp: 1340, race: 'demon', size: 'small', element: 'dark', area: 'ancient-dungeon-8f', isBoss: false, debuffs: [{ type: 'curse', chance: 18 }] },
  // 遠古地監 9F Lv.55~60 (Boss)
  { id: 133, name: '遠古凶獸', level: 59, hp: 720, attackMin: 57, attackMax: 77, defense: 36, exp: 1420, race: 'normal', size: 'large', element: 'none', area: 'ancient-dungeon-9f', isBoss: false, debuffs: [{ type: 'bleed', chance: 20 }, { type: 'stun', chance: 10 }] },
  ...
  { id: 136, name: '遠古食人妖精', level: 60, hp: 660, attackMin: 55, attackMax: 74, defense: 35, exp: 1360, race: 'demon', size: 'small', element: 'dark', area: 'ancient-dungeon-9f', isBoss: false, debuffs: [{ type: 'curse', chance: 18 }] },
  ...
  // 百柱塔 1~10F Lv.45~52
  { id: 138, name: '百柱蜘蛛', level: 46, hp: 480, attackMin: 42, attackMax: 57, defense: 26, exp: 970, race: 'normal', size: 'small', element: 'dark', area: 'hundred-pillar-1-10f', isBoss: false, debuffs: [{ type: 'poison', chance: 18 }] },
