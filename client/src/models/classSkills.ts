...
export const CLASS_SKILLS: ClassSkillDef[] = [
  ...
  { id: 'element-storm', name: '元素風暴', className: 'elementalist', classLevel: 5, requiredLevel: 50, bookName: '元素風暴技能書',
    skill: { id: 'element-storm', name: '元素風暴', level: 5, element: 'fire', type: 'attack', target: 'aoe', power: 100, mpCost: 80, cooldown: 20000, range: 12, aoeCenter: 'target', aoeRadius: 10, maxTargets: 10 } },
  ...
  { id: 'holy-judgment', name: '聖光審判', className: 'priest', classLevel: 4, requiredLevel: 40, bookName: '聖光審判技能書',
    skill: { id: 'holy-judgment', name: '聖光審判', level: 4, element: 'light', type: 'attack', target: 'aoe', power: 70, mpCost: 60, cooldown: 15000, range: 10, aoeCenter: 'target', aoeRadius: 6, maxTargets: 6 } },
