...
export const CLASS_SKILLS: ClassSkillDef[] = [
  ...
  { id: 'arrow-rain', name: '穿透箭雨', className: 'elf', classLevel: 5, requiredLevel: 50, bookItemId: 111,
    skill: { id: 'arrow-rain', name: '穿透箭雨', level: 5, element: 'none', type: 'attack', target: 'aoe', power: 52, mpCost: 55, cooldown: 15000, range: 15, aoeCenter: 'target', aoeRadius: 6, maxTargets: 6, requiredWeaponType: 'bow', ignoreDefensePercent: 50, description: '無視目標 50% 防禦' } },
  ...
  { id: 'mana-drain', name: '魔力奪取', className: 'elementalist', classLevel: 2, requiredLevel: 20, bookItemId: 113,
    skill: { id: 'mana-drain', name: '魔力奪取', level: 2, element: 'none', type: 'attack', target: 'single', power: 19, mpDrainRatio: 1, mpCost: 0, cooldown: 12000, range: 8, description: '造成傷害，並回復等同最終傷害的MP' } },
  ...
  { id: 'element-storm', name: '元素風暴', className: 'elementalist', classLevel: 5, requiredLevel: 50, bookItemId: 116,
    skill: { id: 'element-storm', name: '元素風暴', level: 5, element: 'fire', type: 'attack', target: 'aoe', power: 75, mpCost: 80, cooldown: 20000, range: 12, aoeCenter: 'target', aoeRadius: 10, maxTargets: 10 } },
  ...
  { id: 'holy-judgment', name: '聖光審判', className: 'priest', classLevel: 4, requiredLevel: 40, bookItemId: 120,
    skill: { id: 'holy-judgment', name: '聖光審判', level: 4, element: 'light', type: 'attack', target: 'aoe', power: 52, mpCost: 60, cooldown: 15000, range: 10, aoeCenter: 'target', aoeRadius: 6, maxTargets: 6 } },
