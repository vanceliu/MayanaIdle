...
export const CLASS_SKILLS: ClassSkillDef[] = [
  ...
  { id: 'arrow-rain', name: '穿透箭雨', className: 'elf', classLevel: 5, requiredLevel: 50, bookName: '穿透箭雨技能書',
    skill: { id: 'arrow-rain', name: '穿透箭雨', level: 5, element: 'none', type: 'attack', target: 'aoe', power: 50, mpCost: 55, cooldown: 15000, range: 15, aoeMin: 4, aoeMax: 6, requiredWeaponType: 'bow', ignoreDefensePercent: 50, description: '無視目標 50% 防禦' } },
  ...
  { id: 'greater-cd-reduce', name: '強化冷卻縮減', className: 'elementalist', classLevel: 4, requiredLevel: 40, bookName: '強化冷卻縮減技能書',
