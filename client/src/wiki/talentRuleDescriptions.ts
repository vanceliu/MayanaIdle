...
export const COMBAT_CONDITION_DESC: Record<string, string> = {
  ...
  monsters_near_self_gte: `${COMBAT_CONDITION_HINTS.monsters_near_self_gte!}（未指定時 ${DEFAULT_NEAR_SELF_RADIUS} 格）`,
  ...
  target_distance: '與當前目標的距離（格）。遠程職業拉開距離的依據',
...
export const PERSISTENT_CONDITION_DESC: Record<string, string> = {
  ...
  monsters_near_self_gte: '以角色為圓心、指定格數內的怪物數，用來判斷是不是被圍住了',
